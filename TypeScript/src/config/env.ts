...
interface TraderInfo {
    address: string;
    name: string;
    category?: 'UpDown' | 'Politics' | 'Sports' | 'Weather'| 'HighTech'| 'Finance'  | 'Other'| 'Elon';
}
...
const KNOWN_TRADERS_INFO: TraderInfo[] = [
    ...
    { address: '0x7c3db723f1d4d8cb9c550095203b686cb11e5c6b', name: 'Car', category: 'Politics' },
    { address: '0xb2caffc47672b897121b4f4a5dbe1ee75fbf0ac2', name: 'EveryMoleIsMagic' },
    { address: '0x689ae12e11aa489adb3605afd8f39040ff52779e', name: 'Annica', category: 'Elon'  },
    ...
    { address: '0xc747b8f900a08f59974f50989e0703344ba0324b', name: 'Nadin592', category: 'UpDown' },
    { address: '0xeee92f1cc6d6e0ad0b4ffda20b01cf3678e27ecb', name: 'ComTruise', category: 'UpDown' },
    ...
    { address: '0x0b9cae2b0dfe7a71c413e0604eaac1c352f87e44', name: 'MCgenius', category: 'Sports' },
    ...
    { address: '0xd82079c0d6b837bad90abf202befc079da5819f6', name: 'Maze8', category: 'Sports' },
